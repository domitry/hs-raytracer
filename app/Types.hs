module Types where
    ...
    data Ray = Ray !Float !Vf !Vf deriving Show -- time, orig, dir
    ...
    hitBox (tmin, tmax) (AABB xrng yrng zrng) (Ray _ (V3 ax ay az) (V3 bx by bz)) = imax > imin
            where
    ...
    extend::Ray->Float->Vf
    extend (Ray _ orig dir) t = orig + t*^dir
